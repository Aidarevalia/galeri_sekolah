                                ...
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="hapus_kategori.php?id=<?php echo $d['id']; ?>" class="btn btn-danger btn-md mb-3" onclick="return confirm('Apakah anda yakin ingin menghapus?');">Hapus<a/>
                                                <i class="fas fa-trash"></i></a>
                                                <a href="edit_kategori.php?id=<?php echo $d['id']; ?>" class="btn btn-warning btn-md mb-3">Edit<a/>
