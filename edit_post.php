...
if(isset($_POST['submit'])) {
    ...
    $sql_update = "UPDATE post SET judul='$judul' WHERE id=$id";
    $sql_update = "UPDATE post SET kategoril='$kategori' WHERE id=$id";
    $sql_update = "UPDATE post SET isi='$isi' WHERE id=$id";
    $sql_update = "UPDATE post SET petugas='$isi' WHERE id=$id";
